...
const predefined: CafeItem[] = [

    {
        ...
        itemName: "Peach Ice Tea",

        description: "A refreshing iced tea with peach flavor.",
        ...
        image: "https://i.pinimg.com/1200x/f2/e2/31/f2e231dc2f95f86f1bbbd53e1f73e78e.jpg",

        ingredients: ["Sugar", "Peach Essence", "Milk"]
...

    {
        ...
        ingredients: ["Mango Essence", "Citrus Syrup", "Lemon Zest"]
